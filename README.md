...
| [databricks](https://github.com/faroshq/providers/tree/main/providers/databricks) | Databricks connections, warehouses and tables as workspace resources, with a `query_table` action |
...
Linear and Databricks source is maintained in the private `faroshq/providers`
