...
// Package framework provides shared test infrastructure for railgrid e2e tests.
package framework
...
var (
	...
	// RailgridBin is the path to the railgrid binary under test.
	RailgridBin string
...
func init() {
	...
	flag.StringVar(&RailgridBin, "railgrid-bin", "bin/railgrid", "Path to the railgrid CLI binary")
