...
//   - kcp admin            tilt-frontproxy.kubeconfig          (RAILGRID_E2E_TILT_KUBECONFIG)
...
const (
	...
	providersWorkspace = "root:railgrid:providers"
	infraGroup         = "infrastructure.railgrid.ai"
	infraAPIExportName = "infrastructure.providers.railgrid.ai"
)
...
func TestMain(m *testing.M) {
	...
	frontproxyKC = envOr("RAILGRID_E2E_TILT_KUBECONFIG", filepath.Join(repoRoot, "tilt-frontproxy.kubeconfig"))
	hubURL = strings.TrimRight(envOr("RAILGRID_E2E_HUB_URL", "https://localhost:9443"), "/")
	infraURL = strings.TrimRight(envOr("RAILGRID_E2E_INFRA_URL", "http://localhost:8082"), "/")
	staticToken = envOr("RAILGRID_E2E_STATIC_TOKEN", "dev-token")
