    ...
    <div v-if="!readonly" class="flex flex-wrap items-center gap-2">
      <div class="relative min-w-[200px] flex-1">
        <input
          ...
          title="Start typing an email, or a member ID such as faros:static:02d4b…, to see matching people. Everyone can copy their member ID from their account menu."
          role="combobox"
