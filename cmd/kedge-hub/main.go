...
func main() {
	...
	cmd.Flags().StringVar(&opts.PublishedAppsDomain, "published-apps-domain", "", "DNS zone published apps are served under (e.g. apps.kedge.example); enables the login-time published-app authorize endpoints")
