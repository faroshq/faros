...
func NewReconciler(log logr.Logger, kubernetescli kubernetes.Interface) *AlertWebhookReconciler {
...
func (r *AlertWebhookReconciler) Reconcile(request ctrl.Request) (ctrl.Result, error) {
	...
	return reconcile.Result{}, r.setAlertManagerWebhook(context.TODO(), "http://aro-operator-faroser.openshift-azure-operator.svc.cluster.local:8080")
}
