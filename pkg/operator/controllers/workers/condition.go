...
func setCondition(ctx context.Context, faroscli farosclient.FarosV1alpha1Interface, request ctrl.Request, cond *status.Condition) error {
	return retry.RetryOnConflict(retry.DefaultRetry, func() error {
		obj, err := faroscli.Workers().Get(ctx, request.Name, metav1.GetOptions{})
		if err != nil {
			return err
		}
		...
		_, err = faroscli.Workers().UpdateStatus(ctx, obj, metav1.UpdateOptions{})
		return err
	})
}

func setStaticStatus(obj *farosv1alpha1.Worker) (changed bool) {
