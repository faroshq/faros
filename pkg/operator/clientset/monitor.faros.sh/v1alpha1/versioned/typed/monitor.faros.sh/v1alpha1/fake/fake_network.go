...
var networksResource = schema.GroupVersionResource{Group: "monitor.faros.sh", Version: "v1alpha1", Resource: "networks"}

var networksKind = schema.GroupVersionKind{Group: "monitor.faros.sh", Version: "v1alpha1", Kind: "Network"}
