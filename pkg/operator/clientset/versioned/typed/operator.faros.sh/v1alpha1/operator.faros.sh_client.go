...
import (
	...
	v1alpha1 "github.com/faroshq/faros/pkg/operator/apis/operator.faros.sh/v1alpha1"
	"github.com/faroshq/faros/pkg/operator/clientset/versioned/scheme"
)
...
// OperatorV1alpha1Client is used to interact with features provided by the operator.faros.sh group.
type OperatorV1alpha1Client struct {
	restClient rest.Interface
}

func (c *OperatorV1alpha1Client) Clusters() ClusterInterface {
