...
var clustersResource = schema.GroupVersionResource{Group: "operator.faros.sh", Version: "v1alpha1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "operator.faros.sh", Version: "v1alpha1", Kind: "Cluster"}
