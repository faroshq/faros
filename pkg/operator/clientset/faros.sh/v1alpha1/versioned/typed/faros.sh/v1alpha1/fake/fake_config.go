...
var configsResource = schema.GroupVersionResource{Group: "faros.sh", Version: "v1alpha1", Resource: "configs"}

var configsKind = schema.GroupVersionKind{Group: "faros.sh", Version: "v1alpha1", Kind: "Config"}
...
func (c *FakeConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(configsResource, name), &v1alpha1.Config{})
	return err
}
