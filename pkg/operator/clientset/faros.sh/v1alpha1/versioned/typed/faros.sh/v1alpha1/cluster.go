...
import (
	...
	scheme "github.com/faroshq/faros/pkg/operator/clientset/faros.sh/v1alpha1/versioned/scheme"
)
...
func newClusters(c *FarosV1alpha1Client, namespace string) *clusters {
	return &clusters{
		client: c.RESTClient(),
		ns:     namespace,
	}
