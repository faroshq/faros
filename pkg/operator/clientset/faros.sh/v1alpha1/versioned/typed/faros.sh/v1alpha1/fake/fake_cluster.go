...
var clustersResource = schema.GroupVersionResource{Group: "faros.sh", Version: "v1alpha1", Resource: "clusters"}

var clustersKind = schema.GroupVersionKind{Group: "faros.sh", Version: "v1alpha1", Kind: "Cluster"}
