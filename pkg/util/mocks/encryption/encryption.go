...
// Source: github.com/faroshq/faros/pkg/util/encryption (interfaces: AEAD)
...
func (m *MockAEAD) Open(arg0 string) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockAEAD) Seal(arg0 string) (string, error) {
	m.ctrl.T.Helper()
