...
import (
	...
	errutil "github.com/appvia/cluster-registry-operator/pkg/util/error"
)
...
func WithReferrer(w http.ResponseWriter, r *http.Request, f func(referrer *url.URL)) {
	...
	if err != nil {
		errutil.WriteCloudError(w, errutil.NewCloudError(http.StatusBadRequest, errutil.CloudErrorCodeInvalidParameter, errInvalidReferrer.Error()))
		return
	}
