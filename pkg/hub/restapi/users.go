...
const (
	...
	// RBAC identity, "faros:static:<hash>").
	staticMemberIDPrefix = "faros:static:"
)
...
// member ID ("faros:static:<hash>" or "static:<hash>"), and whether it was
// one.
func staticSearchHash(q string) (string, bool) {
	return strings.CutPrefix(strings.TrimPrefix(q, "faros:"), "static:")
}
...
//     ("faros:static:02d4b" or "static:02d4b"). Every static member ID starts
//     with the same "faros:static:", so matching on less would list them all.
//
