...
func searchTestUser(name, email, displayName string) *tenancyv1alpha1.User {
	return &tenancyv1alpha1.User{
		...
		Spec:       tenancyv1alpha1.UserSpec{Email: email, Name: displayName, RBACIdentity: "faros:" + email},
	}
}
...
func TestSearchUsers(t *testing.T) {
	...
	static := &tenancyv1alpha1.User{
		...
		Spec:       tenancyv1alpha1.UserSpec{Name: "faros:static:47b9dce0e91570a1", RBACIdentity: "faros:static:47b9dce0e91570a1"},
	}
	...
	for _, tc := range []struct {
		...
		// carries 5 characters of the hash: the shared "faros:static:" part
		// alone must not list them all.
		{name: "static prefix alone", q: "faros:static:", want: nil},
		{name: "static 4 hash chars", q: "faros:static:47b9", want: nil},
		{name: "static 5 hash chars", q: "faros:static:47b9d", want: []string{"static-user-47b9dce0e91570a1"}},
	...
	if len(items) != 1 || items[0].MemberID != "faros:static:47b9dce0e91570a1" || items[0].Email != "" {
