...
| `provider_enabled_total` | counter | platform | `telemetry/metrics/provider_enabled_total.yaml` | Total provider enablement outcomes. | provider_enabled [unique workspace] | outcome=success; provider=agents,app-studio,code,databricks,edges,infrastructure,kuery,quickstart |
