...
export const MARKETPLACE: MarketplaceApp[] = [
  {
    ...
    chart: { repoURL: 'https://grafana.github.io/helm-charts', chart: 'grafana', version: '10.5.15' },
    port: 80,
  ...
  },
  {
    ...
    chart: { repoURL: 'https://prometheus-community.github.io/helm-charts', chart: 'prometheus', version: '29.27.0' },
    port: 9090,
  ...
  },
  {
    ...
    chart: { repoURL: 'https://k8s-at-home.com/charts', chart: 'qbittorrent', version: '13.5.2' },
    port: 8080,
  ...
  },
  {
    ...
    chart: { repoURL: 'https://k8s-at-home.com/charts', chart: 'prowlarr', version: '4.5.2' },
    port: 9696,
  ...
  },
  {
    ...
    chart: { repoURL: 'https://k8s-at-home.com/charts', chart: 'sonarr', version: '16.3.2' },
    port: 8989,
    values: { persistence: { config: { enabled: true, size: '1Gi' } } },
    credential: 'api-key',
  },
  {
    ...
    chart: { repoURL: 'https://k8s-at-home.com/charts', chart: 'radarr', version: '16.3.2' },
    port: 7878,
    values: { persistence: { config: { enabled: true, size: '1Gi' } } },
    credential: 'api-key',
  },
  {
    ...
    chart: { repoURL: 'https://jellyfin.github.io/jellyfin-helm', chart: 'jellyfin', version: '3.2.0' },
    port: 8096,
