...
describe('resource detail cards', () => {
  ...
  it('uses six shared provider-owned icon stat cards for both edge kinds', () => {
    ...
    expect(farosUI).toMatch(/@container resource-page \(max-width: 620px\)[\s\S]*\.k-resource-stat-cards[\s\S]*repeat\(2/)
    expect(farosUI).toMatch(/@container resource-page \(max-width: 420px\)[\s\S]*\.k-resource-stat-cards[\s\S]*minmax\(0, 1fr\)/)
