...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TableQuery) DeepCopyInto(out *TableQuery) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TableQuery.
func (in *TableQuery) DeepCopy() *TableQuery {
	if in == nil {
		return nil
	}
	out := new(TableQuery)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *TableQuery) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TableQueryList) DeepCopyInto(out *TableQueryList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]TableQuery, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TableQueryList.
func (in *TableQueryList) DeepCopy() *TableQueryList {
	if in == nil {
		return nil
	}
	out := new(TableQueryList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *TableQueryList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TableQuerySpec) DeepCopyInto(out *TableQuerySpec) {
	*out = *in
	if in.Columns != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TableQuerySpec.
func (in *TableQuerySpec) DeepCopy() *TableQuerySpec {
	if in == nil {
		return nil
	}
	out := new(TableQuerySpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TableQueryStatus) DeepCopyInto(out *TableQueryStatus) {
	*out = *in
	if in.Columns != nil {
		in, out := &in.Columns, &out.Columns
		*out = make([]QueryColumn, len(*in))
		copy(*out, *in)
	}
	if in.Rows != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TableQueryStatus.
func (in *TableQueryStatus) DeepCopy() *TableQueryStatus {
	if in == nil {
		return nil
	}
	out := new(TableQueryStatus)
	in.DeepCopyInto(out)
	return out
}
