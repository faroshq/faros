// SecretsElement is the custom element the faros portal renders for the
// secrets provider. It mounts a Vue 3 app in its own light-DOM container and
// survives portal re-renders by keeping a single app instance whose props are
// driven by the .farosContext setter. Mirrors the code provider's element.ts.

import { createApp, h, reactive, type App as VueApp } from 'vue'
import App from './App.vue'
import type { FarosContext } from './types'

export class SecretsElement extends HTMLElement {
  ...
  connectedCallback(): void {
    ...
    this._host.className = 'secrets-host'
