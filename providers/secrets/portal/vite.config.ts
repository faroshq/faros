...
// The faros hub serves this provider under /ui/providers/secrets/. ProviderFrame
// injects <script src="/ui/providers/secrets/main.js"> and waits for the
// <faros-provider-secrets> custom element to be defined. So the build must emit
