...
// Package scheme builds the runtime.Scheme the secrets provider's controller
// manager and clients share: the provider's own secrets.faros.sh types plus
// core/v1 (the controllers read credential Secrets and write projected
// Secrets in tenant workspaces) and the kcp apis.kcp.io types the
// multicluster apiexport provider needs.
package scheme
...
func NewScheme() *runtime.Scheme {
	...
	utilruntime.Must(secretsv1alpha1.AddToScheme(s))
	return s
}
