...
func (p *Proxy) handleCallback(w http.ResponseWriter, r *http.Request) {
	...
	returnPath, returnCookie, ok := p.consumeReturnState(w, r, state, partitioned)
	if !ok {
...
func (p *Proxy) consumeReturnState(w http.ResponseWriter, r *http.Request, state string, partitioned bool) (string, string, bool) {
