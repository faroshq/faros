...
func (s *Server) Register(r *mux.Router) {
	...
	r.HandleFunc("/api/projects/production-templates", s.listProductionTemplates).Methods(http.MethodGet)
	...
	r.HandleFunc("/api/projects/{project}/components", s.listProjectComponents).Methods(http.MethodGet)
	r.HandleFunc("/api/projects/{project}/components/{component}", s.upsertProjectComponent).Methods(http.MethodPut)
	r.HandleFunc("/api/projects/{project}/components/{component}", s.deleteProjectComponent).Methods(http.MethodDelete)
	r.HandleFunc("/api/projects/{project}/dependencies/catalog", s.getProjectDependencyCatalog).Methods(http.MethodGet)
	r.HandleFunc("/api/projects/{project}/dependencies", s.listProjectDependencies).Methods(http.MethodGet)
	r.HandleFunc("/api/projects/{project}/dependencies/{dependency}", s.upsertProjectDependency).Methods(http.MethodPut)
	r.HandleFunc("/api/projects/{project}/dependencies/{dependency}", s.deleteProjectDependency).Methods(http.MethodDelete)
	r.HandleFunc("/api/projects/{project}/build", s.getProjectBuildConfiguration).Methods(http.MethodGet)
	r.HandleFunc("/api/projects/{project}/build", s.putProjectBuildConfiguration).Methods(http.MethodPut)
	...
	// Universal-sandbox projects may expose more than one user-declared HTTP
	// process. These resources are observed and reconciled by Infrastructure;
	// App Studio only owns the project-scoped intent and primary selector.
	r.HandleFunc("/api/projects/{project}/development-services", s.listProjectDevelopmentServices).Methods(http.MethodGet)
	r.HandleFunc("/api/projects/{project}/development-services/{service}", s.upsertProjectDevelopmentService).Methods(http.MethodPut)
	r.HandleFunc("/api/projects/{project}/development-services/{service}", s.deleteProjectDevelopmentService).Methods(http.MethodDelete)
	r.HandleFunc("/api/projects/{project}/development-services/{service}/logs", s.logsProjectDevelopmentService).Methods(http.MethodGet)
	r.HandleFunc("/api/projects/{project}/development-services/{service}/restart", s.restartProjectDevelopmentService).Methods(http.MethodPost)
	r.HandleFunc("/api/projects/{project}/development-services/primary", s.setProjectDevelopmentPrimaryService).Methods(http.MethodPost)
	r.HandleFunc("/api/projects/{project}/development-listeners", s.listProjectDevelopmentListeners).Methods(http.MethodGet)
