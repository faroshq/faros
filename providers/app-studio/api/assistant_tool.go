...
func projectAssistantToolBundleForSpec(spec projectAssistantToolSpec) projectAssistantToolBundle {
	...
	case projectToolGetRuntimeStatus, projectToolGetPreviewURL, projectToolInspectDevelopmentPreview, projectToolGetPreviewConsoleLogs,
		...
		projectToolListDevelopmentServices, projectToolUpsertDevelopmentService, projectToolDeleteDevelopmentService, projectToolRestartDevelopmentService, projectToolSetPrimaryPreviewService, projectToolListDetectedListeners,
		projectToolUpsertProjectComponent, projectToolDeleteProjectComponent,
		projectToolListDependencyTemplates, projectToolListProjectDependencies, projectToolUpsertProjectDependency, projectToolDeleteProjectDependency:
