...
func TestProjectAssistantToolRegistryListsLocalToolsInOrder(t *testing.T) {
	...
	want := []string{
		...
		"list_development_services",
		"upsert_development_service",
		"delete_development_service",
		"restart_development_service",
		"set_primary_preview_service",
		"list_detected_development_listeners",
		"get_project_build_configuration",
		"set_project_build_workflow",
		"upsert_project_component",
		"delete_project_component",
		"list_dependency_templates",
