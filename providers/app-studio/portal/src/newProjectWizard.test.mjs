...
test('pre-project attachments stay parent-owned across both intake surfaces and hand off receipts with the prompt', () => {
  ...
  assert.match(preProjectComposerSource, /aria-label="Remove attachment"/)
  assert.match(preProjectComposerSource, /Retry attachment upload/)
  ...
  assert.match(attachmentPreviewSource, /aria-label="Remove attachment"/)
