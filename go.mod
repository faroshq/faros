...
replace (
	...
	github.com/kcp-dev/kcp => github.com/kcp-dev/kcp v0.0.0-20230213175357-49d1b8c2ab42
	github.com/kcp-dev/kcp/pkg/apis => github.com/kcp-dev/kcp/pkg/apis v0.0.0-20230213175357-49d1b8c2ab42
