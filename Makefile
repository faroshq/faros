...
.PHONY: telemetry-codegen verify-telemetry
...
telemetry-codegen: ## Validate and generate the activation telemetry catalog
	go run ./hack/telemetry-codegen

verify-telemetry: ## Verify activation telemetry generated files are clean
	go run ./hack/telemetry-codegen --verify

codegen: crds codegen-code-provider codegen-app-studio-provider codegen-databricks-provider codegen-infrastructure-provider telemetry-codegen boilerplate ## Generate all (CRDs + kcp resources + provider schemas + telemetry + boilerplate)
...
verify: verify-boilerplate verify-codegen verify-telemetry verify-portalkit verify-app-studio-preview-console-dev-key verify-app-studio-eval vet lint build test ## Run all checks
